...
class Common:
    ...
    def add_task_args(cls, subparser):
        ...
        gparser.add_argument('--shape-model', choices=('Wu', 'Foo', 'External', 'ShapeTransformer',"ShapeConv", 'RiboEM', 'ContraSE', 'Helix', 'Corr'),default='Wu',
                            help="shape model nll->Wu,Foo,RiboEM, ContraSE, Helix, Corr, class-> ShapeTransformer, ShapeConv, External")
